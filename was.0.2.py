...
kgp='/data_cacike/Databases/VCF/ALL.wgs.phase3_shapeit2_mvncall_integrated_v5b.20130502.sites.vcf.gz'
exac='/data_cacike/Databases/VCF/ExAC.r0.3.1.sites.vep.vcf.gz'
ensembl='GRCh37.75'
cadd='/data_cacike/Software/CADD_v1.3/bin/score.sh'
snpeff='java -jar -Xmx40G /data_cacike/Software/snpEff/snpEff.jar'
vcftools='vcftools'
plink='plink'
bgzip='bgzip'
tabix='tabix'
emmax='/data_cacike/Software/emmax-beta-07Mar2010/emmax'
emmaxkin='/data_cacike/Software/emmax-beta-07Mar2010/emmax-kin'
priority='/data_cacike/Software/snpEff/snpeff4.priority.stdin.ann.py'
king='/data_cacike/Software/king'
r='/usr/local/bin/R-3.1.2'
